...
for item in items:
    ...
    if (chname in placeName.keys()):
        if chname in ["美国", "泰国", "新加坡", "日本", "马来西亚", "澳大利亚", "韩国", "法国", "德国", "越南", "加拿大", "尼泊尔", "柬埔寨", "斯里兰卡", "菲律宾", "阿联酋", "英国", "印度", "俄罗斯", "意大利", "比利时", "西班牙", "瑞典", "芬兰", "埃及", "伊朗", "科威特", "阿曼", "巴林", "以色列", "阿富汗", "伊拉克", "黎巴嫩", "巴西", "奥地利", "克罗地亚", "瑞士", "阿尔及利亚","巴基斯坦","希腊", "爱沙尼亚", "罗马尼亚", "北马其顿", "挪威", "格鲁吉亚","阿塞拜疆","白俄罗斯","立陶宛","新西兰","荷兰"]:
        ...
        if confirmed == "" or confirmed == "-" :
            confirmed = "0"
        if chname not in ["美国", "泰国", "新加坡", "日本", "马来西亚", "澳大利亚", "韩国", "法国", "德国", "越南", "加拿大", "尼泊尔", "柬埔寨", "斯里兰卡","菲律宾", "阿联酋", "英国", "印度", "俄罗斯", "意大利", "比利时", "西班牙", "瑞典", "芬兰", "埃及", "伊朗", "科威特", "阿曼", "巴林", "以色列", "阿富汗", "伊拉克", "黎巴嫩", "巴西", "奥地利", "克罗地亚", "瑞士", "阿尔及利亚","巴基斯坦","希腊", "爱沙尼亚", "罗马尼亚", "北马其顿", "挪威", "格鲁吉亚","阿塞拜疆","白俄罗斯","立陶宛","新西兰","荷兰"]:
